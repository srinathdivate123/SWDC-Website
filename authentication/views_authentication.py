    ...
    if request.method == "GET":
        ...
        if user.first_name == 'Volunteer':
            ...
            if user_object.password_changed == False:
                messages.error(request,   'There is no need to receive a reset link to reset your password as your password is your PRN. You have not changed it after logging in. So, use your PRN as your password to login.')
                return redirect ('login')
